...
BEGIN
    ...
    VALUES (N'Adams', N'J', N'PX-1001', '1980-03-11', 1);
END
GO

IF NOT EXISTS (SELECT 1 FROM dbo.Patients WHERE HospitalNumber = N'PX-1002')
BEGIN
    INSERT INTO dbo.Patients (Surname, Initials, HospitalNumber, DateOfBirth, Sex)
    VALUES (N'Brown', N'M', N'PX-1002', '1992-07-24', 2);
END
GO

IF NOT EXISTS (SELECT 1 FROM dbo.Patients WHERE HospitalNumber = N'PX-1003')
BEGIN
    INSERT INTO dbo.Patients (Surname, Initials, HospitalNumber, DateOfBirth, Sex)
    VALUES (N'Clark', N'T', N'PX-1003', '1975-12-02', 1);
END
GO
